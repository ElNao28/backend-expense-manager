...
export class FirstMigration1764692980534 implements MigrationInterface {
    name = 'FirstMigration1764692980534'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firtsname" text NOT NULL, "lastname" text NOT NULL, "second_lastname" text, "email" text NOT NULL, "phone" integer NOT NULL, "password" text NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "delete_at" TIMESTAMP, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_a000cca60bcf04454e727699490" UNIQUE ("phone"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
